...
public class GUserInterface extends BaseGameServerRegister implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (cmd.equals("exit"))
		{
			...
			JOptionPane.showMessageDialog(getFrame(), getBundle().getString("credits") + CommonConfig.EOL + "http://www.l2jserver.com" + CommonConfig.EOL + CommonConfig.EOL + getBundle().getString("icons") + CommonConfig.EOL + CommonConfig.EOL + getBundle().getString("langText") + CommonConfig.EOL + getBundle().getString("translation"), getBundle().getString("aboutItem"), JOptionPane.INFORMATION_MESSAGE, ImagesTable.getImage("l2jserverlogo.png"));
		}
