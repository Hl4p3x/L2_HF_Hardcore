...
import static com.l2jserver.gameserver.engines.LogicHelper.joinAnd;
	...
	protected Condition parseTargetCondition(Node n, Object template)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			switch (a.getNodeName().toLowerCase())
			{
				...
				case "using":
				{
					cond = ConditionParsingHelper.parseTargetUsingKind(a, cond);
					break;
				}
				case "npcid":
				{
	...
	protected Condition parseUsingCondition(Node n)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			switch (a.getNodeName().toLowerCase())
			{
				case "kind":
				{
					cond = ConditionParsingHelper.parseSelfUsingKind(a, cond);
					break;
				}
				case "slot":
				{
