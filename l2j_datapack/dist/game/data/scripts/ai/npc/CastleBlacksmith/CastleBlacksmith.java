...
public final class CastleBlacksmith extends AbstractNpcAI
{
	...
	{
        return player.canOverrideCond(PcCondOverride.CASTLE_CONDITIONS) || npc.isMyLord(player) || ((player.getClanId() == npc.getCastle().getOwnerClanId()) && player.hasClanPrivilege(ClanPrivilege.CS_MANOR_ADMIN));
	}
