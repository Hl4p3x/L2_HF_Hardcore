...
public class HtmCache
{
	...
	public void reload() {
		reload(CommonConfig.DATAPACK_ROOT);
	}
	...
	public String loadFile(File file) {
		...
		final String relpath = Util.getRelativePath(CommonConfig.DATAPACK_ROOT, file);
		String content = null;
	...
	private String getHtm(String path)
	{
		...
		if (Config.LAZY_CACHE && (content == null)) {
			content = loadFile(new File(CommonConfig.DATAPACK_ROOT, path));
		}
		return content;
	}
	...
	public boolean isLoadable(String path) {
		return HTML_FILTER.accept(new File(CommonConfig.DATAPACK_ROOT, path));
	}
