...
public class ThreadPoolManager
{
	...
	public String getPacketStats()
	{
		...
		if (tf instanceof PriorityThreadFactory) {
            ...
            StringUtil.append(sb, "General Packet Thread Pool:" + CommonConfig.EOL + "Tasks in the queue: ", String.valueOf(_generalPacketsThreadPool.getQueue().size()), CommonConfig.EOL + "Showing threads stack trace:" + CommonConfig.EOL + "There should be ", String.valueOf(count), " Threads" + CommonConfig.EOL);
	...
	public String getIOPacketStats()
	{
		...
		if (tf instanceof PriorityThreadFactory) {
            ...
            Thread[] threads = new Thread[count + 2];
            ptf.getGroup().enumerate(threads);
            StringUtil.append(sb, "I/O Packet Thread Pool:" + CommonConfig.EOL + "Tasks in the queue: ", String.valueOf(_ioPacketsThreadPool.getQueue().size()), CommonConfig.EOL + "Showing threads stack trace:" + CommonConfig.EOL + "There should be ", String.valueOf(count), " Threads" + CommonConfig.EOL);
	...
	public String getGeneralStats()
	{
		...
		if (tf instanceof PriorityThreadFactory) {
            ...
            Thread[] threads = new Thread[count + 2];
            ptf.getGroup().enumerate(threads);
            StringUtil.append(sb, "General Thread Pool:" + CommonConfig.EOL + "Tasks in the queue: ", String.valueOf(_generalThreadPool.getQueue().size()), CommonConfig.EOL + "Showing threads stack trace:" + CommonConfig.EOL + "There should be ", String.valueOf(count), " Threads" + CommonConfig.EOL);
