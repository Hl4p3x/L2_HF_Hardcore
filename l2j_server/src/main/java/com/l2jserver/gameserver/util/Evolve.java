...
public final class Evolve
{
	...
	public static final boolean doEvolve(L2PcInstance player, L2Npc npc, int itemIdtake, int itemIdgive, int petminlvl, long price)
	{
		...
		if (!player.reduceAdena("PetEvolve", price, currentPet, true)) {
			return false;
		}
