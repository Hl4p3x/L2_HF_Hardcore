...
public final class GameServer
{
	...
	public GameServer() throws Exception {
		...
		timeIt("Scripts", () -> {
			...
			try {
				...
				if (!Config.ALT_DEV_NO_HANDLERS || !Config.ALT_DEV_NO_QUESTS) {
                    L2ScriptEngineManager.getInstance().executeScriptList(new File(CommonConfig.DATAPACK_ROOT, "data/scripts.cfg"));
                }
        ...
        sc.MAX_READ_PER_PASS = CommonConfig.MMO_MAX_READ_PER_PASS;
        sc.MAX_SEND_PER_PASS = CommonConfig.MMO_MAX_SEND_PER_PASS;
        sc.SLEEP_TIME = CommonConfig.MMO_SELECTOR_SLEEP_TIME;
        sc.HELPER_BUFFER_COUNT = CommonConfig.MMO_HELPER_BUFFER_COUNT;
        sc.TCP_NODELAY = CommonConfig.MMO_TCP_NODELAY;
