...
public class GameServerRegister extends BaseGameServerRegister
{
	...
	public void consoleUI() throws IOException
	{
		...
		while (true) {
            ...
            System.out.println(CommonConfig.EOL);
				...
				try
				{
					...
					switch (choiceNumber)
					{
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            System.out.printf(getBundle().getString("invalidChoice") + CommonConfig.EOL, choice);
                            choiceOk = false;
                    }
	 ...
	 */
	private void hr() {
        System.out.println("_____________________________________________________" + CommonConfig.EOL);
    }
	...
	private void unregisterSingleGS() throws IOException
	{
		...
		do
		{
			...
			try
			{
                ...
                System.out.printf(getBundle().getString("invalidChoice") + CommonConfig.EOL, line);
            }
		}
		...
		if (name == null) {
            System.out.printf(getBundle().getString("noNameForId") + CommonConfig.EOL, id);
        }
		else
		{
			if (GameServerTable.getInstance().hasRegisteredGameServerOnId(id)) {
                System.out.printf(getBundle().getString("confirmRemoveText") + CommonConfig.EOL, id, name);
                try {
                    BaseGameServerRegister.unregisterGameServer(id);
                    System.out.printf(getBundle().getString("unregisterOk") + CommonConfig.EOL, id);
                } catch (SQLException e) {
                ...
                System.out.printf(getBundle().getString("noServerForId") + CommonConfig.EOL, id);
            }
		}
	...
	public void showError(String msg, Throwable t)
	{
		...
		if (getBundle() != null) {
            ...
            msg += CommonConfig.EOL + getBundle().getString("reason") + ' ' + t.getLocalizedMessage();
        }
		else {
            title = "Error";
            msg += CommonConfig.EOL + "Cause: " + t.getLocalizedMessage();
        }
