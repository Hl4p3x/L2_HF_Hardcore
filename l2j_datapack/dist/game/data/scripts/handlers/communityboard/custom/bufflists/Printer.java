...
public class Printer {
    ...
    public static void main(String[] args) {
        System.out.println(Stream.of(new Dominator().getBuffs(), new Doomcryer().getBuffs(), new ElvenSaint().getBuffs(),
                new Hierophant().getBuffs(), new Others().getBuffs(), new ShillenSaint().getBuffs(),
